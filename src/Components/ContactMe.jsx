        ...
        <>
            <ReachMeContainer id="contactme">
                ...
                <Row>
                    ...
                    <ReachMeContainerTitleH2>Donne moi de tes nouvelles</ReachMeContainerTitleH2>

                    <ReachMeContainerTitleH3>Contactez-moi</ReachMeContainerTitleH3>
                    </ReachMeContainerTitle>
                    <div className="row">
                    <div className="col-md-6">
                        ...
                        <div className="row">
                            ...
                            <ContactDetail>
                                ...
                                <ContactMi>
                                <ContactMiH4>Téléphone:</ContactMiH4>
                                <ContactMiText>+237655925698 / +237 681805142</ContactMiText>
                                </ContactMi>
                            </ContactDetail>
                            </ContactInfo>
                            <ContactInfo>
                            <ContactDetail>
                                ...
                                <ContactMiText>monkamcabrel11@gmail.com</ContactMiText>
                                </ContactMi>
                            </ContactDetail>
                            </ContactInfo>
                            <ContactInfo>
                            <ContactDetail>
                                ...
                                <ContactMi>
                                <ContactMiH4>Adresse:</ContactMiH4>
                                <ContactMiText>30345 Rue de la chapelle nsymeyong, Yaoundé, Cameroun</ContactMiText>
                                </ContactMi>
                            </ContactDetail>
                            </ContactInfo>
                        </div>
